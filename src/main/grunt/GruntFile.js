module.exports = function(grunt) {
	...
	var globalConfig = {
		...
		assetsDirectoryRelative : path
				.basename(grunt.option('assetsDirectory')),
	...
	grunt
			.initConfig({
				...
				bootstrap : grunt.file
						.readJSON('bower_components/bootstrap/package.json'),
				banner : '/*!\n'
				...
				jshint : {
					all : [ 'Gruntfile.js',
							'<%=globalConfig.assetsDirectory%>/js/main.js' ],
					options : {
						jshintrc : '.jshintrc'
					}
				},
	...
	grunt.registerTask('default', 'build static webapp resources', [
			'bowercopy', 'googlefonts', 'less' ]);
};